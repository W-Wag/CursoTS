...
var repeatPassword = document.querySelector('.password2');
...
function hideErrorMessages(form) {
    form.querySelectorAll('.' + SHOW_ERROR_MESSAGES).forEach(function (field) {
...
function shouldSendForm(form) {
    var send = true;
    form.querySelectorAll('.' + SHOW_ERROR_MESSAGES).forEach(function () {
        send = false;
    });
    return send;
}
